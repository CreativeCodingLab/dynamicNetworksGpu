...
int main(int argc, char *argv[]) {
	...
	*/
	...
	/*
	Init variable to contain the aggregation data.
	*/
	aggregation = (int*)malloc((imagesInfo.imageNumber - TIME_WINDOW) * (1 / range));
	resetData(aggregation, range, imagesInfo);
	...
	*/
	...
	/// Save aggregation.
	saveData(aggregation, range, imagesInfo, EVENT, TIME_WINDOW);
...
*/
int** loadOnGpu(int* data, std::string str){
